...
[![Node CI Status](https://github.com/erboladaiorg/corporis-ducimus/workflows/Node%20CI/badge.svg)](https://github.com/erboladaiorg/corporis-ducimus/actions)
[![npm](https://img.shields.io/npm/v/@erboladaiorg/corporis-ducimus.svg)](https://www.npmjs.com/package/@erboladaiorg/corporis-ducimus)
[![codecov](https://codecov.io/gh/erboladaiorg/corporis-ducimus/branch/master/graph/badge.svg)](https://codecov.io/gh/erboladaiorg/corporis-ducimus)
...
```sh
npm install --save @erboladaiorg/corporis-ducimus
```
...
```js
const { validator } = require('@erboladaiorg/corporis-ducimus')
...
```js
const { parser } = require('@erboladaiorg/corporis-ducimus')
...
`@erboladaiorg/corporis-ducimus` supports the formats specified in JSON schema v4 (such as date-time).
...
When the `includeErrors` option is set to `true`, `@erboladaiorg/corporis-ducimus` also outputs:
...
See the [doc/samples](./doc/samples/) directory to see how `@erboladaiorg/corporis-ducimus` compiles
...
`@erboladaiorg/corporis-ducimus` uses code generation to turn a JSON schema into javascript code that is easily
...
```sh
git clone https://github.com/erboladaiorg/corporis-ducimus
cd schemasafe
...
Compared to `is-my-json-valid`, `@erboladaiorg/corporis-ducimus` adds security-first design, many new features,
